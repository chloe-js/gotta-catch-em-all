...
let pkmList = [
  ...
  ['Squirtell', "https://raw.githubusercontent.com/PokeAPI/sprites/master/sprites/pokemon/shiny/132.png", 364, [
      ['Aqua Tail', 'water', 90, 0.95],
      ['Tackle', 'normal', 90, 0.95],
      ['Water Pulse', 'water', 100, 0.95],
      ['Bubble', 'water', 85, 0.95]
  ]]
];
let typeMatch = {
  'Charizard': [
